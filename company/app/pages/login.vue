 ...
 */
import { Bot, CloudOff, LogIn, ShieldAlert } from 'lucide-vue-next'
import {
  ...
  <div class="flex min-h-dvh items-center justify-center bg-[var(--c-bg)] p-4">
    <div class="card w-full max-w-sm p-6">
      <div class="flex items-center gap-2">
        <Bot class="h-6 w-6 text-brand" aria-hidden="true" />
        <h1 class="text-[18px] font-bold">AKEBONO Company</h1>
      </div>
