...
export const seedAiTasks: AiTask[] = [
  ...
  },
  {
    ...
    description: 'DX 構想策定支援のキックオフに向けた提案書の初稿を作成する',
    decomposition: [
...
/** 通知（AI 報告・エスカレーションのデモ） */
export const seedNotifications: AppNotification[] = [
  { id: 'nt-0001', memberId: 'm-04', kind: 'ai_report', title: 'AI 完了報告: 7 月定例の議事録清書とナレッジ登録', body: 'ハル がタスクを完了しました', link: '/tasks?task=at-0005', read: false, at: `${addDays(today, -1)}T10:03:00+09:00` },
  { id: 'nt-0002', memberId: 'm-03', kind: 'ai_report', title: 'AI 確認依頼: シーサイドホテルズ DX 提案書ドラフト', body: 'ユキ から確認: 参照してよい過去提案の範囲を指定してください', link: '/tasks?task=at-0004', read: false, at: `${addDays(today, -1)}T16:51:00+09:00` },
]

/** エスカレーション（低確信度の起票デモ） */
export const seedEscalations: Escalation[] = [
  {
    id: 'esc-0001', reason: 'low_confidence', targetMemberId: null, targetAiEmployeeId: 'ai-03',
    context: 'AI社員への依頼「旧 KPI レポートのフォーマット移行」の確信度が低いため確認が必要',
    status: 'open', resolution: null, knowledgeReflected: false,
    dedupeKey: 'lowconf:ai-03', raisedAt: `${addDays(today, -2)}T16:46:00+09:00`,
  },
]
