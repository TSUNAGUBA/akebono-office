...
const {
  metricsFor, integratedMetricsFor, metricsReady, metricsWarningFor, refreshMetrics, integratedReady,
} = useMediaAnalytics()
...
const integratedLoading = computed(() => isApi && connected.value && !integratedReady(effectiveSegmentId.value, 6))
/**
