  ...
  const rows: Array<Omit<CustomerLog, 'createdAt' | 'updatedAt'> & { back: number; at: string }> = [
    {
      ...
      logDate: d(1), logTime: '14:30', companyId: 'c-01', contactId: 'p-01',
      title: 'SCM 追加提案の打診',
