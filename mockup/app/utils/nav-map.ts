...
export const NAV_MAP: Record<string, NavMapEntry> = {
  ...
  '/akebono': { parent: HOME },
  '/akebono/products': { parent: { to: '/akebono', label: 'AKEBONO 業務' }, related: [{ to: '/akebono/inventory', label: '在庫管理' }, { to: '/akebono/masters', label: '共通マスタ', adminOnly: true }, { to: '/akebono/settings/items', label: '項目カスタマイズ', adminOnly: true }] },
  ...
  '/akebono/masters': { parent: { to: '/akebono', label: 'AKEBONO 業務' }, related: [{ to: '/masters/customers', label: '顧客(会社)マスタ', adminOnly: true }, { to: '/akebono/settings/items', label: '項目カスタマイズ', adminOnly: true }] },
  ...
  '/akebono/settings/items': { parent: { to: '/akebono', label: 'AKEBONO 業務' }, related: [{ to: '/akebono/masters', label: '共通マスタ', adminOnly: true }] },
  '/menu': { parent: HOME },
