...
export const NAV_MAP: Record<string, NavMapEntry> = {
  ...
  '/akebono': { parent: HOME, related: [{ to: '/media', label: 'メディア分析' }] },
  '/media': { parent: HOME, related: [{ to: '/media/analytics', label: 'メディア分析' }, { to: '/media/articles', label: 'AI 記事生成' }, { to: '/media/settings', label: 'メディア設定', adminOnly: true }, { to: '/akebono', label: 'AKEBONO 業務' }] },
  ...
  '/media/articles': { parent: { to: '/media', label: 'メディア分析' }, related: [{ to: '/media/analytics', label: 'メディア分析' }, { to: '/media/settings', label: 'メディア設定', adminOnly: true }] },
  '/media/settings': { parent: { to: '/media', label: 'メディア分析' }, related: [{ to: '/media/analytics', label: 'メディア分析' }, { to: '/akebono/settings/segments', label: '業態アプリ設定', adminOnly: true }] },
  ...
  '/akebono/inventory': { parent: { to: '/akebono', label: 'AKEBONO 業務' }, related: [{ to: '/akebono/inbounds', label: '入荷管理' }, { to: '/akebono/outbounds', label: '出荷管理' }, { to: '/akebono/products', label: '商品マスタ' }] },
  '/akebono/inbounds': { parent: { to: '/akebono', label: 'AKEBONO 業務' }, related: [{ to: '/akebono/purchase-orders', label: '発注管理' }, { to: '/akebono/purchases', label: '仕入管理' }, { to: '/akebono/inventory', label: '在庫管理' }] },
  '/akebono/outbounds': { parent: { to: '/akebono', label: 'AKEBONO 業務' }, related: [{ to: '/akebono/inventory', label: '在庫管理' }, { to: '/akebono/sales', label: '売上管理' }] },
  '/akebono/purchase-orders': { parent: { to: '/akebono', label: 'AKEBONO 業務' }, related: [{ to: '/akebono/inbounds', label: '入荷管理' }, { to: '/akebono/purchases', label: '仕入管理' }] },
  '/akebono/purchases': { parent: { to: '/akebono', label: 'AKEBONO 業務' }, related: [{ to: '/akebono/purchase-orders', label: '発注管理' }, { to: '/akebono/billing', label: '請求管理' }] },
  '/akebono/production': { parent: { to: '/akebono', label: 'AKEBONO 業務' }, related: [{ to: '/akebono/inventory', label: '在庫管理' }, { to: '/akebono/products', label: '商品マスタ' }] },
  '/akebono/sales': { parent: { to: '/akebono', label: 'AKEBONO 業務' }, related: [{ to: '/akebono/billing', label: '請求管理' }, { to: '/decision', label: '意思決定支援' }] },
  '/akebono/billing': { parent: { to: '/akebono', label: 'AKEBONO 業務' }, related: [{ to: '/akebono/sales', label: '売上管理' }, { to: '/akebono/masters', label: '委託条件マスタ', adminOnly: true }] },
  '/akebono/masters': { parent: { to: '/akebono', label: 'AKEBONO 業務' }, related: [{ to: '/akebono/settings/segments', label: '業態アプリ設定', adminOnly: true }, { to: '/masters/customers', label: '顧客(会社)マスタ', adminOnly: true }, { to: '/akebono/settings/items', label: '項目カスタマイズ', adminOnly: true }] },
  '/akebono/imports': { parent: { to: '/akebono', label: 'AKEBONO 業務' }, related: [{ to: '/akebono/masters', label: '共通マスタ', adminOnly: true }, { to: '/akebono/products', label: '商品マスタ' }] },
  '/akebono/settings/items': { parent: { to: '/akebono', label: 'AKEBONO 業務' }, related: [{ to: '/akebono/settings/segments', label: '業態アプリ設定', adminOnly: true }, { to: '/akebono/masters', label: '共通マスタ', adminOnly: true }] },
  '/akebono/settings/segments': { parent: { to: '/akebono', label: 'AKEBONO 業務' }, related: [{ to: '/akebono/masters', label: '共通マスタ', adminOnly: true }, { to: '/akebono/products', label: '商品マスタ' }, { to: '/akebono/settings/items', label: '項目カスタマイズ', adminOnly: true }] },
  '/menu': { parent: HOME },
