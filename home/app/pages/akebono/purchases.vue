        ...
        <div>
          ...
          <div class="grid gap-1.5">
            ...
            >
              ...
              <span class="num hidden text-right tabular-nums sm:block">{{ fmtYen(l.costPrice) }}</span>
              <span class="num hidden text-right tabular-nums sm:block">{{ fmtYen(l.subtotal) }}</span>
              <span class="num text-[12px] text-sub tabular-nums sm:hidden">数量 {{ fmtInt(l.qty) }} × {{ fmtYen(l.costPrice) }} = <span class="font-semibold text-ink">{{ fmtYen(l.subtotal) }}</span></span>
            </div>
