...
export const seedCompanies: Company[] = [
  ...
  { id: 'c-01', kind: 'customer', name: 'アケボノ商事', aliases: ['アケボノ', 'akebono'], industryIds: ['ind-01', 'ind-02'], primaryIndustryId: 'ind-01', size: '1000名以上', location: '東京都', phone: '03-0000-0100', description: '全国展開の総合小売チェーン。SCM プラットフォーム導入先', ownerMemberId: 'm-03', fiscalStartMonth: null, active: true, custom: {} },
  { id: 'c-02', kind: 'customer', name: 'ウンドゥアパレル', aliases: ['ウンドゥ', 'UNDEUX'], industryIds: ['ind-02'], primaryIndustryId: 'ind-02', size: '300-1000名', location: '大阪府', phone: '06-0000-0200', description: '婦人服製造小売。売上分析スイートの提供先', ownerMemberId: 'm-04', fiscalStartMonth: null, active: true, custom: {} },
