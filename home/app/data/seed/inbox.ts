...
export const seedNotifications: AppNotification[] = [
  ...
  { id: 'nt-0010', memberId: 'm-03', kind: 'comment', title: '顧客活動にメンションがありました', body: '「北都物流 定例（8/8）: 次回までに KPI 定義案を共有」— 三浦', link: '/customer-log', read: false, at: `${today}T11:20:00+09:00` },
