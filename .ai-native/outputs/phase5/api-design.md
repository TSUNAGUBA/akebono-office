...
| AKO-CLG-001 | 顧客ログの入力不正（日付・開始/終了時刻・属性タグ・会社・担当者メモ/議事録メモ・FK 未存在） | ✅ |
