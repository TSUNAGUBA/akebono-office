...
| AKO-NCH-001 | チャネル連携が未設定（Slack/Google の OAuth クライアント未構成 = 環境変数なし。400。改修依頼 2026-08-20） | ✅ |
