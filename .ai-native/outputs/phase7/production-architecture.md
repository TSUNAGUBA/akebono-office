...
13. **バッチ5a（本 PR・オペレーター指示 2026-07-17）:** 顧客関係マスタの 3 分割（会社・人・関係種別）+ 提出済み日報の本人編集 + Calendar API 自動有効化 + バッチ4b レビュー指摘対応
14. **バッチ5 続き:** 権限制御基盤（ロール/役職層 + 個人層・表示項目レベル）→ チャットボットの全 DB 参照化（権限準拠）
15. **バッチ4 続き（バッチ5 の後）:** AI カンパニー・売上 + mart ETL・稼働状況
