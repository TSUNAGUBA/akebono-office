...
14. **バッチ5b（本 PR）:** チャットボットのセッション管理（chat_sessions / chat_messages・マルチターン・過去セッション再開・新規開始）
15. **バッチ5 続き:** 権限制御基盤（ロール/役職層 + 個人層・表示項目レベル）→ チャットボットの全 DB 参照化（権限準拠）
16. **バッチ4 続き（バッチ5 の後）:** AI カンパニー・売上 + mart ETL・稼働状況
