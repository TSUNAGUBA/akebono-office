...
- **バッチ5b（本 PR・オペレーター指示 2026-07-17）:** チャットボットのセッション管理（DB 永続・マルチターン・過去セッション再開・新規開始）
...
## 8. 今回バッチ（5b: チャットボットのセッション管理）の完了条件（Definition of Done）
...
- [ ] バッチ5 続き: 権限制御基盤（ロール/役職層 + 個人層・表示項目レベル）→ チャットボット全 DB 参照化 / その後バッチ4 続き: AI カンパニー → 売上 + mart ETL → 稼働状況
